...
from src.config import METRICS_DIR, MODELS_DIR, ensure_project_dirs, split_path
...
MODEL_FACTORIES = {
    "baseline_nb": make_baseline_pipeline,
    "main_lr": make_main_pipeline,
}
...
def train_one_model(
    ...
    payload = {
        ...
        "split_path": str(split_path(subset)),
...
def main() -> None:
    ...
    parser.add_argument(
        "--model",
        default="both",
        choices=("both", "baseline_nb", "main_lr"),
    ...
    for payload in payloads:
        print(
            ...
            f"{metrics_path(payload['subset'], payload['model'], payload['variant'])}"
        )
